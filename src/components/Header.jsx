...
import logo from "../assets/logo.webp"; // ✅ safer than "/src/assets/logo.webp"
...
export default function Header() {
  ...
  const navLinkClass = ({ isActive }) =>
    `relative text-sm font-medium transition-colors after:absolute after:bottom-[-6px] after:left-0 after:h-[2px] after:w-0 after:bg-sky-500 after:transition-all hover:after:w-full ${
      isActive
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-lg border-b border-gray-200/70 shadow-sm">
