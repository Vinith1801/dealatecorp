...
import Card from "../components/ServiceCard"; // Reuse ServiceCard for grid items
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16 space-y-20">
      ...
      <section className="text-center max-w-3xl mx-auto space-y-4">
        <motion.h1 initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.6 }} className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight">
          About Us
        </motion.h1>
        <motion.p initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.6, delay: 0.15 }} className="text-lg text-gray-600 leading-relaxed">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {whatWeDo.map((item, idx) => (
            <motion.div key={idx} initial="hidden" whileInView="visible" variants={sectionVariant} custom={idx} viewport={{ once: true }}>
